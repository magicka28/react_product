        ...
        return (
            <>
                <div className="buttons d-flex justify-content-center mb-5 pb-5">
                    ...
                    <button className="btn btn-outline-dark me-2" onClick={()=>filterProduct("men's clothing")}>Driver</button>
                                    ...
                                    <div class="card h-100 text-center p-4" key={product.id}>
                                        <img class="card-img-top" src={product.image} alt={product.title} height="250px"/>
                                            <div class="card-body">
                                                ...
                                                <p class="card-text lead fw-bold">Quantiy - {parseInt(product.price)}</p>
                                                <NavLink to={`/products/${product.id}`} class="btn btn-outline-dark">View Item</NavLink>
                                            </div>
                                    </div>
                                </div>
                            </>
